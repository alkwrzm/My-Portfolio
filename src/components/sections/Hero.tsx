...
export default function Hero() {
    return (
        <section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-20">
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
                ...
                <div className="flex flex-col items-start text-left gap-6 order-2 lg:order-1">
                    ...
                    <div className="flex flex-wrap gap-3 animate-in fade-in slide-in-from-left-4 duration-500">
                        ...
                        {/* Experience Badge */}
                        <div
                            className="flex items-center gap-2 px-4 py-2 rounded-full border border-secondary/20 bg-secondary/5 text-secondary text-xs font-mono tracking-widest uppercase"
                        >
                    ...
                    {/* Typewriter Subtitle */}
                    <div
                        className="text-xl md:text-2xl text-muted-foreground font-light h-8 animate-in fade-in duration-1000 delay-200 fill-mode-both"
                    >
                        <TypeAnimation
                            sequence={[
                    ...
                    <div
                        className="mt-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both"
                    >
                        <Button
                            size="lg"
                ...
                <div
                    className="w-full h-[400px] md:h-[500px] relative order-1 lg:order-2 flex items-center justify-center p-8 lg:p-0 animate-in fade-in zoom-in-95 duration-1000"
                >
            ...
            {/* Scroll Indicator */}
            <div
                className="absolute bottom-10 left-1/2 -translate-x-1/2 text-muted-foreground text-xs font-mono flex flex-col items-center gap-2 animate-in fade-in duration-1000 delay-1000"
            >
